...
app = Flask(__name__)
##postgress
engine = create_engine("mysql+pymysql://root:sikandar.123@localhost:3306/sikandar")
...
def view():
    if request.method == "POST":
        ...
        db.execute("INSERT into fee(firstname, lastname, session, submittedfee, duefee, totalfee) VALUES (:firstname, :lastname, :session, :submittedfee, :duefee, :totalfee)",
